...
function register_rockset(name, recipe_cobble, recipe_stone, image)
    ...
    minetest.register_node("hades_rocks:".. name .."_round", {
    ...
    minetest.register_craft({
        output = "hades_rocks:".. name .."_round 1",
        recipe = {
            {"",            recipe_cobble,  ""},
    ...
    -- Now for pillar_90
     minetest.register_node("hades_rocks:".. name .."_pillar_90", {
    ...
    minetest.register_craft({
        output = "hades_rocks:".. name .."_pillar_90 1",
        recipe = {
            {"",    recipe_stone,   ""},
            {"",    recipe_cobble,  ""},
            {"",    recipe_cobble,  ""},
    ...
    -- Now for pillar_45
     minetest.register_node("hades_rocks:".. name .."_pillar_45", {
    ...
    minetest.register_craft({
        output = "hades_rocks:".. name .."_pillar_45 1",
        recipe = {
            {"",    "",             recipe_stone},
            {"",    recipe_cobble,  ""},
            {"",    recipe_cobble,  ""},
    ...
    -- Now for large_flat
     minetest.register_node("hades_rocks:".. name .."_large_flat", {
    ...
    minetest.register_craft({
        output = "hades_rocks:".. name .."_large_flat 1",
        recipe = {
            {"",                "",              ""},
    ...
    -- Now for flat
     minetest.register_node("hades_rocks:".. name .."_flat", {
    ...
    minetest.register_craft({
        output = "hades_rocks:".. name .."_flat 1",
        recipe = {
            {"",                "",              ""},
    ...
    -- Now for glove
    minetest.register_node("hades_rocks:".. name .."_glove", {
    ...
    minetest.register_craft({
        output = "hades_rocks:".. name .."_glove 1",
        recipe = {
            {"",                "",              ""},
    ...
    -- Now for spike
    minetest.register_node("hades_rocks:".. name .."_spike", {
    ...
    minetest.register_craft({
        output = "hades_rocks:".. name .."_spike 1",
        recipe = {
            {"",                recipe_stone,              ""},
            {recipe_stone,      recipe_cobble,    recipe_stone},
            {recipe_cobble,     recipe_cobble,   recipe_cobble},
    ...
    -- Now for stub
    minetest.register_node("hades_rocks:".. name .."_stub", {
    ...
    minetest.register_craft({
        output = "hades_rocks:".. name .."_stub 1",
        recipe = {
            {"",                "",              ""},
            {"",                recipe_stone,    ""},
            {recipe_cobble,     recipe_cobble,   recipe_cobble},
